...
! function(t) {
    ...
    n(98), n(100), n(101), n(103), n(259), n(260), t.exports = n(261)
}, function(t, e, n) {
    "use strict";
    var r = n(8);
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t().attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
    ...
    t.exports = function(t, e, n, E, _, g) {
        ...
        if (b && !O) return g || (g = new r), y || f(t) ? i(t, e, n, E, _, g) : o(t, e, m, n, E, _, g);
        if (!(n & l)) {
        ...
        switch (i) {
            ...
            case ct:
                var T = n.config,
                    ...
                    S = T.aValue;
                return {
                    rValue: O, gValue: A, bValue: b, aValue: S
                };
            case it:
    ...
    function yt(t) {
        ...
        if (C ? (S = N.limitAffectedElements, w = L, R = u(N)) : w = R = u({
            ...
            var x = r && (R || !0 === A) ? [r] : c(L);
            if (R) {
                if (A === U) return c(R).filter(function(t) {
                    return x.some(function(e) {
                        return d(t, e)
                    })
                });
                if (A === X) return c(R).filter(function(t) {
                    return x.some(function(e) {
                        return d(e, t)
                    })
                });
                if (A === V) return c(R).filter(function(t) {
                    return x.some(function(e) {
                        return v(e, t)
                    })
                })
        ...
        O = function(t, e) {
            ...
            if (r && i) {
                ...
                if (s) {
                    var b = O - a,
                        S = m + T,
                        w = v(Math.min(Math.max(0, b / S), 1));
                    t = (0, o.set)(t, "verboseTimeElapsed", S * w)
                }
                if (A < 0) return t;
                var R = v(Math.min(Math.max(0, A / m), 1)),
                    N = h(y, R, g),
                    C = {},
                    L = null;
    ...
    var c, s, f, l = u(n(18)),
        ...
        _t = (r = {}, (0, o.default)(r, R, vt()), (0, o.default)(r, N, ht()), (0, o.default)(r, w, vt()), (0, o.default)(r, S, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, x, ht(!1)), (0, o.default)(r, C, vt()), (0, o.default)(r, L, ht()), (0, o.default)(r, k, {
            ...
            handler: function(t) {
                ...
                return A && (b > .95 || b < .05) && (b = Math.round(b)), (u !== h.EventBasedOn.ELEMENT || w || w !== a.elementHovered) && (b = f ? 1 - b : b, e.dispatch((0, _.parameterChanged)(S, b))), {
                    elementHovered: w,
                    clientX: v,
                    clientY: g,
                    pageX: I,
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f040c8ad0b82a71fac61a1f|a6430327-9fe8-de36-4e3e-cd34c011c052"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".single-product-wrapper",
                "originalId": "5f040c8ad0b82a71fac61a1f|22268090-8e0d-b6da-b8fd-73f4308f3699",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
        ...
        "e-7": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f040c8ad0b82a71fac61a1f|76ef6566-7156-65b1-8427-12ae231161cc"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
    ...
    "actionLists": {
        "a": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["07aa77c4-dbcc-d2de-6af7-ed6024642db3"]
                        },
                        "xValue": 1.1,
                        "yValue": 1.1,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5f040c8ad0b82a71fac61a1f|22268090-8e0d-b6da-b8fd-73f4308f3699"
                        },
                        "rValue": 246,
                        "gValue": 242,
                        "bValue": 237,
            ...
            "createdOn": 1594969081463,
            "useFirstGroupAsInitialState": false
        },
        "a-2": {
            "id": "a-2",
            "title": "Hover OUT // Product",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_SCALE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["48488f6e-608e-9502-a06b-e180f6d71d56"]
                        },
                        "xValue": 8,
                        "xUnit": "PX",
                        "yUnit": "PX",
